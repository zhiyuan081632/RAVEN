...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract TalkNet visual features",
        epilog='Examples:\n'
               '  python extract_visual_features_TalkNet.py input_dir output_dir\n'
               '  python extract_visual_features_TalkNet.py --list train_list.txt\n',
    ...
    parser.add_argument("--list", nargs='+', default=None, dest='file_lists',
                        help="List file(s) with mp4 absolute paths (output: /mp4/ -> /TalkNet/)")
