...
_code_to_dtype = {
    ...
    4: np.int32,
    5: np.int64,
    6: np.float64,  # np.float was deprecated in numpy 1.20
    7: np.float64,  # np.double was deprecated in numpy 1.20
    8: np.uint16,
    9: np.uint32,
    10: np.uint64,
}
...
class IndexedDatasetBuilder:
    element_sizes = {
        ...
        np.int32: 4,
        np.int64: 8,
        np.float64: 4,  # np.float was deprecated in numpy 1.20
        np.float64: 8,  # np.double was deprecated in numpy 1.20
    }
